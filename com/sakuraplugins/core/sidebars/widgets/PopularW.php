...
class ATLAS_PopularW extends WP_Widget {

	const DEFAULT_POST_NO = 5;

	public function __construct(){
		parent::__construct(
			'atlas_popular_widget',
			esc_html__('Atlas: Popular Articles', 'atlas-knb-textdomain'),
			array(
				'classname' => 'atlas_widget',
				'description' => esc_html__('Shows popular articles based on visits', 'atlas-knb-textdomain')
			)
		);
	}

	public function form($instance) {
		$title = isset($instance['title' ]) ? $instance['title'] : esc_html__('Popular articles', 'atlas-knb-textdomain');
